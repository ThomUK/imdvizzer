...
This project is designed to visualise the UK's Index of Multiple Deprivation (IMD) data in as many ways (or as few) as needed.  It uses the [{geographr}](https://github.com/humaniverse/geographr) package for map geometries and area lookup files, and the [{IMD}](https://github.com/humaniverse/IMD) package for IMD data.
